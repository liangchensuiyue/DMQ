...
var file_header_proto_rawDesc = []byte{
	...
	0x6c, 0x69, 0x76, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x22, 0xb2, 0x01, 0x0a, 0x0a, 0x48, 0x65, 0x61,
	...
	0x4d, 0x61, 0x73, 0x74, 0x65, 0x72, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x22, 0x1f, 0x0a,
	...
	0x74, 0x61, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x32, 0xf2, 0x06, 0x0a, 0x10, 0x44, 0x4d, 0x51,
	...
	0x65, 0x72, 0x2e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x30, 0x0a,
	0x1c, 0x63, 0x6f, 0x6d, 0x2e, 0x6c, 0x69, 0x61, 0x6e, 0x67, 0x63, 0x68, 0x65, 0x6e, 0x2e, 0x44,
	0x4d, 0x51, 0x48, 0x65, 0x61, 0x64, 0x65, 0x72, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x42, 0x0e, 0x44,
	0x4d, 0x51, 0x48, 0x65, 0x61, 0x64, 0x65, 0x72, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x62,
...
var file_header_proto_depIdxs = []int32{
	...
	11, // 14: DMQHeader.DMQHeaderService.FollowerRegistToHeaderRequest:output_type -> DMQHeader.Response
	11, // 15: DMQHeader.DMQHeaderService.FollowerToHeaderRequestDataRequest:output_type -> DMQHeader.Response
	11, // 16: DMQHeader.DMQHeaderService.FollowerCancelTopicRequest:output_type -> DMQHeader.Response
	11, // 17: DMQHeader.DMQHeaderService.FollowerYieldMsgDataRequest:output_type -> DMQHeader.Response
	11, // 18: DMQHeader.DMQHeaderService.ProofClientRequest:output_type -> DMQHeader.Response
	4,  // 19: DMQHeader.DMQHeaderService.GetHeaderInfoRequest:output_type -> DMQHeader.HeaderInfo
	4,  // 20: DMQHeader.DMQHeaderService.EnterCluster:output_type -> DMQHeader.HeaderInfo
	3,  // 21: DMQHeader.DMQHeaderService.PingPong:output_type -> DMQHeader.PingPongData
	11, // 22: DMQHeader.DMQHeaderService.CommitTx:output_type -> DMQHeader.Response
	11, // 23: DMQHeader.DMQHeaderService.Prepare:output_type -> DMQHeader.Response
	2,  // 24: DMQHeader.DMQHeaderService.GetTxDataByTx:output_type -> DMQHeader.TxDatas
	11, // 25: DMQHeader.DMQHeaderService.Transfer2Master:output_type -> DMQHeader.Response
